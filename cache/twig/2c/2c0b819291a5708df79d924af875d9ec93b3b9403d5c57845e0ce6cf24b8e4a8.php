...
class __TwigTemplate_1606dabbf86e0a1f4477babfda25b33924a8e4198abfa582ca7528a8adc5640d extends Twig_Template
{
    ...
    {
        // line 1
        $context["value"] = $this->env->getExtension('Grav\Common\Twig\TwigExtension')->evaluateStringFunc($this->env, $context, $this->getAttribute(($context["field"] ?? null), "condition", array()));
        // line 2
...
{% if value %}
    ...
    {% endif %}
{% endif %}
", "forms/fields/conditional/conditional.html.twig", "/Users/dev/Boulot/Mathieu Roy/PulX/pulx/user/plugins/form/templates/forms/fields/conditional/conditional.html.twig");
    }
}
